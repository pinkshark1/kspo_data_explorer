...
### 👉 [KSPO 데이터 지도 바로가기](https://pinkshark1.github.io/kspo_data_explorer/)
...
>
> KSPO 데이터 지도는 데이터를 단순히 나열하는 목록이 아니라, **필요한 데이터를 발견하고 실제 활용까지 이어주는 데이터 탐색 창구**를 목표로 합니다.